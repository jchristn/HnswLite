namespace HnswIndex.Server.Classes
{
    ...
    internal static class Constants
    {
        ...
        public static string Logo =
            ...
            @" | |_  _ _  ____ __ __ " + Environment.NewLine +
            @" | ' \| ' \(_-< V  V / " + Environment.NewLine +
            @" |_||_|_||_/__/\_/\_/  " + Environment.NewLine;
                      

        /// <summary>
        /// Product name.
        /// </summary>
        public static string ProductName = " HNSW Index Server";
        ...
        /// Settings file.
        /// </summary>
        public static string SettingsFile = "./hnswindex.json";
        ...
        /// Log filename.
        /// </summary>
        public static string LogFilename = "hnswindex.log";
        ...
        /// </summary>
        public static string WebserverPortEnvironmentVariable = "HNSW_PORT";

        /// <summary>
        /// Data database filename environment variable.
        /// </summary>
        public static string DatabaseFilenameEnvironmentVariable = "HNSW_DB";
        ...
        public static string DefaultHomepage =
            "<html>"
            + "<head><title>HNSW Index Server</title></head>"
            + "<body>"
            + "<div><pre>" + Logo + Environment.NewLine
            + " Your HNSW Index Server node is operational</p></div>"
            + "</body>"
            + "</html>";
